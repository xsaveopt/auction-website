...
PORTS_INTERNAL="443 80 9113 2019"
EXEC_MOUNTS=""
REQUIRED_RW="/data"
ENV_REPORT="APP_ENV APP_DEBUG APP_URL SERVER_NAME DB_DATABASE CACHE_STORE SESSION_DRIVER QUEUE_CONNECTION REDIS_HOST REDIS_PORT OCTANE_WORKERS OCTANE_MAX_REQUESTS MICROSOFT_CLIENT_ID MICROSOFT_CLIENT_SECRET MCP_API_KEY APP_KEY METRICS_TOKEN WEB_PUSH_VAPID_PRIVATE_KEY"
ENV_SECRET="MICROSOFT_CLIENT_SECRET MCP_API_KEY APP_KEY METRICS_TOKEN WEB_PUSH_VAPID_PRIVATE_KEY"
...
link /data/images /app/storage/app/public

mkdir -p /data/logs
rm -rf /app/storage/logs
link /data/logs /app/storage/logs
